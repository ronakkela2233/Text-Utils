...
export default function Navbar(props) {
  return (
    <div>
    <nav style={{backgroundImage: `url(${image})`, backgroundRepeat: "no-repeat", backgroundSize:'cover', backgroundPositionY:"20%"}} className="navbar navbar-expand-lg  mb-5">
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        <li className="nav-item">
          <a className="nav-link active" aria-current="page" href="/" style={{ color: 'purple' }}>Home</a>
        ...
        <li className="nav-item">
          <a className="nav-link active" aria-disabled="true" style={{ color: 'white' }} >{props.aboutText}</a>
        </li>
