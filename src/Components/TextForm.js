    ...
    return (
        <div  className='container' style={mean.lightMode}>
            ...
            <div className="d-flex align-items-center justify-content-between mb-5" style={mean.lightMode}>
                <div>
                    <button type="button" className="btn btn-primary me-3 my-1" onClick={uppercase} style={mean.lightMode}>
                        Convert To Uppercase
                    </button>
                    <button type="button" className="btn btn-primary me-3 my-1" onClick={lowercase} style={mean.lightMode}>
                        Convert To Lowercase
                    </button>
                    <button type="button" className="btn btn-danger me-3 my-1" onClick={Clear} style={mean.lightMode}>
                        Clear
                    </button>
                    ...
                    <button type="button" className="btn btn-danger me-3 my-1" onClick={Refresh} style={mean.lightMode}>
                        Refresh
                    </button>
                    
                </div>
                <p className="mb-0 ms-3">{text.split(/\s+/).filter((element)=>{ return element.length!==0}).length} words and {text.length} characters</p>
            </div>
